...
10. **Git flow**: trabajar en ramas cortas (`feature/`, `fix/`, `chore/`) y
    abrir PR con base `main`. Los PRs los mergea SIEMPRE el owner manualmente —
    ningún agente debe mergear ni cerrar un PR. No commitear artefactos ni
    secretos.
